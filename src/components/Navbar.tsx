          ...
          <div className="flex flex-col sm:flex-row items-center gap-1 sm:gap-4 border-l border-natural-border pl-3 sm:pl-8">
            ...
            {isAuthor && (
              <button
                ...
                className={`text-[10px] sm:text-xs font-bold uppercase tracking-[0.2em] transition-colors ${activeTab === 'my-trips' ? 'text-natural-sage' : 'text-natural-muted hover:text-natural-text'}`}
              >
                My Journeys
              </button>
            )}
