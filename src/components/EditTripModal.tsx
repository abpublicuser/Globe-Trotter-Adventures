...
export default function EditTripModal({ isOpen, onClose, trip }: EditTripModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrorStatus('Failed to update trip. Please try again.');
    } finally {
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          >
            <div className="flex h-16 items-center justify-between border-b border-natural-border px-8">
              <h2 className="text-sm font-bold uppercase tracking-[0.2em] text-natural-text">Edit Journey</h2>
              <button 
                onClick={onClose}
                  ...
                  {preview ? (
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-xs italic text-natural-muted">Choose your journey's main image</p>
                      </div>
                    </div>
                  )}
                  <input
                ...
                >
                  {isUploading || isOptimizing ? (
                    <>
                      ...
                      {isOptimizing ? 'Optimizing Cover...' : 'Saving Changes...'}
                    </>
                  ) : (
                    <>
